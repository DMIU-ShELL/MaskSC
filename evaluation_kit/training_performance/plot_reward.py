...
def plot_seperate(fig, axs, master, plot_name, title='', xaxis_label='Iteration', yaxis_label='Summed Return'):
    ...
    """unique = dict(zip(labels, handles))   # preserves unique labels
    fig.legend(
        unique.values(), 
        unique.keys(), 
        loc='lower center', 
        ncol=2,
        bbox_to_anchor=(0.5, 0.05),  # tweak -0.2 to fit under x-axis label
    )"""
    axs.flat[0].legend()
...
neurips_mctgraph = {
    ...
    'Mask-SC-3' : {
        'Mask-SC-3' : 'raw/ct28-interleaved-MaskSC-top-3/Titerationreward/',
    },

    #'Mask-SC' : {
    #    'Mask-SC' : 'raw/ct28-interleaved-MaskSC-top-dense/Titerationreward/',
    #},

    #'Mask-SC-1' : {
    #    'Mask-SC-1' : 'raw/ct28-interleaved-MaskSC-top-1/Titerationreward/',
    #},
...
neurips_mctgraph_causation_ablation = {
    'No priors' : {
        'No priors' : 'raw/ct28-interleaved-MaskRI/Titerationreward/',
    },
    ...
    'Random-3' : {
        'Random-3' : 'raw/ct28-interleaved-MaskSC-top-3-random/Titerationreward/',
    },

    'Oracle' : {
        'Oracle' : 'raw/ct28-interleaved-MaskSC-top-dense/Titerationreward/',
    },
}
...
if __name__ == '__main__':
    ...
    fig4, axs4 = plt.subplots(3, 3, figsize=(20, 9.5), layout='constrained')
