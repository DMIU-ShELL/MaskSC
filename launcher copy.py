...
elif args.env == 'minigrid_oracle':
    commands = commands_minigrid_oracle
elif args.env == 'ctgraph_ppo':
    commands = commands_ctgraph_ppo
elif args.env == 'ctgraph_sc':
    commands = commands_ctgraph_sc
elif args.env == 'ctgraph_oracle':
    commands = commands_ctgraph_oracle
elif args.env == 'ctgraph_individual':
    commands = commands_ctgraph_single_task_experts
elif args.env == 'ctgraph_sc_random':
    commands = commands_ctgraph_sc_random
